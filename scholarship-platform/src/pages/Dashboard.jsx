...
// // //         <h1 className="text-3xl font-bold mb-4">AKG College Dashboard</h1>
...
// //   const [openDropdown, setOpenDropdown] = useState(null); // tracks which scholarship is clicked
...
// //         {openDropdown === idx && (
// //           <div className="absolute mt-2 p-2 bg-white rounded shadow w-full z-10">
// //             <p className="text-sm text-gray-700 mb-2">Verification Required</p>
// //             <button
